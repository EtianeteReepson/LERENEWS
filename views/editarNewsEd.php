...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="telaEditor">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="updateNewsEd" method="post">
                                <div class="input-group input-group-sm mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-sm">Titulo</span>
                                    <input type="text" value="<?php echo $news['titulo'] ?>" name="tittle" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                                    <input type="hidden" name="id" value="<?php echo $news['id']; ?>">
                                </div>
                                <div class="form-floating">
                                    <textarea name="news" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"><?php echo $news['corpo'] ?>
                                </textarea>
                                </div>
                                <div class="form-floating m-4">
                                    <select name="category" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                                        <option selected value="Politica"><?php echo $news['Categoria'] ?></option>
                                ...
                                <button type="submit" class="btn btn-outline-primary m-4">Editar</button>
                            </form>
                            <!-- TinyMCE Editor -->
